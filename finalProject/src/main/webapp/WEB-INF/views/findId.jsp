					...
					<div class="board-wrap">
						<div class="mypage-form">
							<div class="login-form">
								<div class="form-wrap">
									<div class="tit">
										<h3>아이디 찾기</h3>
										<p>가입 시 입력하셨던 이름, 이메일을 입력해주세요.</p>
									</div>
									<fieldset>
										<form method="post" action="findId.do" name="frmFindId" id="frmFindId" novalidate="novalidate">
											<ul>
												<li>
											...
											<button class="bt" id="btn_findId">확인</button>
										</form>
									</fieldset>
									<p id="userId"></p>
								</div>
						...
						<div id="myModal" class="modal">
							<div class="modal-content">
								...
								<p id="userId"></p>
								<button class="btn" id="btn_checkId">확인</button>
							</div>
						</div>
					</div>
				</div>
