				...
				<div id="conArea">
					<div class="accom-wrap">
						<div id="titleWrap" class="w1200">
							<span class="bitTit">럭셔리 (더블/트윈)</span>
						</div>
						<div class="w1200">
							<div class="roomImg">
							...
							<div class="information">
								...
								<div class="toggle-btn-wrap">
									<a href="rsvn_corner_01.do">코너 스위트</a>
								</div>
								<div class="infoIns">
									...
									<div class="list amenity">
										<ul class="clearfix">
											...
											<li>
												<div>
													<img src="">
													<span>${additional[5]}</span>
												</div>
											</li>
											<li>
												<div>
													<img src="">
													<span>${additional[6]}</span>
												</div>
											</li>
											<li>
												<div>
											...
											<li>
												<div>
													<img src="">
													<span>${additional[7]}</span>
												</div>
											</li>
											<li>
												<div>
													<img src="">
													<span>${additional[8]}</span>
												</div>
											</li>
											<li>
												<div>
